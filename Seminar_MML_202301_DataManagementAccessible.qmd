...
::: columns
::: {.column width="50%"}
-   Organize folders by date, project, species, etc. You'll have to find what works best for you and your program.

-   Create folders with a top-down hierarchy, i.e. folders should get more specific as you get deeper into folder organization.

-   If you're going to do a big reorganization, consider deleting and archiving things first. Don't waste time organizing what you don't need to keep or expect to access regularly.
...
-   Establish a system for version control (e.g. file-naming, Git).

-   Organize images separately.

-   Maintain whatever system you come up with (and that may mean making changes again if it's not working for you) -- check in, clean up annually.
:::
...
-   Use only alpha-numeric characters. Special characters (e.g.: ? ! / \$ % \# \< \>) are often reserved for use by the operating system. If you need files to sort at the top of a list, precede with an underscore (\_).
...
-   Dates should be used in file names in the year_month_day order to maintain chronological order.
